...
m_fun = Menu("Развлечения", buttons=["Прислать собачку", "Прислать лисичку", "Ещё развлечения", "Выход"], parent=m_main)

m_fun2 = Menu("Ещё развлечения", buttons=["Показать новости", "Прислать анекдот", "Прислать фильм", "Выход"], parent=m_fun)